          ...
          <div>
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
              <p data-macaly="about-paragraph-1">
                ...
                technologický stack založený na TypeScriptu, Node.js
                a&nbsp;Reactu (
                <a
                  href="#skills"
              ...
              <p data-macaly="about-paragraph-2">
                K IT mě přivedli bratři - oba odjakživa programátoři, a&nbsp;já
                se rozhodla k&nbsp;nim přidat. Začala jsem intenzivním IT kurzem
                ...
                >
                  ...
                  >
                    ...
                    <span id="skills-list-desc" className="sr-only">
                      - přejde na sekci se seznamem všech technologií a
                      dovedností
                    </span>
                  </a>
                  )
