  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-[10rem] sm:pt-[5rem] md:pt-0">
        ...
        <div className="text-2xl md:text-3xl text-indigo-600 font-light mb-8 space-y-2 text-wrap-balance no-orphans" role="text">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center" role="group" aria-label="Hlavní akce">
          <button 
