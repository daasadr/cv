...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 bg-gray-50" aria-labelledby="skills-title">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Skills List */}
          <div role="region" aria-label="Přehled technických dovedností podle kategorií">
            <div className="space-y-8">
              {Object.entries(
                ...
                >
                  ...
                  <div className="space-y-4" role="list" aria-label={`Seznam dovedností v kategorii ${categoryLabels[category as keyof typeof categoryLabels]}`}>
                        ...
                        <div key={skill.name} className="space-y-2" role="listitem">
                          <div className="flex justify-between items-center">
                            ...
                            <div className="text-right">
                              <span className="text-sm text-gray-500" aria-label={`Zkušenost: ${experienceDesc}`}>
                                {experienceDesc}
                              </span>
                          ...
                          <div className="relative">
                            ...
                            <div className="sr-only">
                              Pokrok v dovednosti {skill.name}: {Math.round(progressPercentage)} procent, 
                              úroveň {experienceLevel}, zkušenost {experienceDesc}
                            </div>
                          </div>
                        </div>
                      );
