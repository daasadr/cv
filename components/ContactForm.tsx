...
export default function ContactForm() {
  ...
  return (
    <section aria-labelledby="contact-form-title">
      <h3 id="contact-form-title" className="text-3xl font-bold text-gray-900 mb-8">
        Odeslat zprávu
      </h3>
      ...
      >
        ...
        >
          ...
          <span id="submit-button-desc" className="sr-only">
            {isSubmitting ? 'Formulář se odesílá, počkejte prosím' : 'Odešle formulář po vyplnění všech povinných polí'}
          </span>
        </button>
        ...
        {submitStatus === 'success' && (
          ...
          >
            ...
            <p className="mt-2">Děkuji! Vaše zpráva byla úspěšně odeslána. Odpovím vám co nejdříve.</p>
          </div>
        )}
        ...
        {submitStatus === 'error' && (
          ...
          >
            ...
            <p className="mt-2">Nepodařilo se odeslat zprávu. Zkuste to prosím znovu nebo mě kontaktujte přímo.</p>
          </div>
        )}
      </form>
    </section>
